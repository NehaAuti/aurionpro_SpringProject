...
public class EmployeeBatchConfig {
    ...
    public JdbcCursorItemReader<Employee> databaseReader(DataSource dataSource) {
    	 return new JdbcCursorItemReaderBuilder<Employee>()
    	            ...
    	            .sql("SELECT employee_id, first_name, last_name, email, salary, department FROM employee")
    	            .rowMapper((rs, rowNum) -> {
    	                Employee employee = new Employee(); // Use no-arg constructor
    ...
    public FlatFileItemWriter<Employee> csvWriter() {
        return new FlatFileItemWriterBuilder<Employee>()
                ...
                .delimited()
                .delimiter(",")
                .names("employeeId", "firstName","lastName", "salary","email","department")
                .headerCallback(writer -> writer.write("employeeId, firstName,lastName, salary,email,department"))
                .build();
    }
